...
time.sleep(2)
driver.find_element(By.XPATH, '/html/body/div[2]/div[2]/div/div/div/div/div[2]/div[1]/div[3]/div[2]/div[2]/div/div/div/button[2]').click()
time.sleep(2)
driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div/div[2]/div/div/div/div[2]/div/div/div[2]/div/input').send_keys("https://www.youtube.com/watch?v=cJjL1Hal6rQ&ab_channel=imlalica")
time.sleep(2)
driver.find_element(By.XPATH, '/html/body/div[5]/div/div/div/div[2]/div/div/div/div[3]/button[2]').click()
time.sleep(2)
